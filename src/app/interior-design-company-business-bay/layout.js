...
export const metadata = {
  ...
  openGraph: {
    ...
    url: 'https://casakraftinteriors.ae/interior-design-company-business-bay',
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              "@context": "https://schema.org",
              "@type": "LocalBusiness",
              "@id": "https://casakraftinteriors.ae/interior-design-company-business-bay",
              "name": "Casa kraft Interior Design & Renovation",
            ...
            __html: JSON.stringify({
              ...
              "mainEntity": [
                ...
                },
                {
                  ...
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Casa kraft Interior Design & Renovation is recognized for delivering high-quality residential and commercial interior design and fit-out projects in Business Bay."
                  }
                }
              ]
            })
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "url": "https://casakraftinteriors.ae/interior-design-company-business-bay",
              "description": "A curated collection of luxury interior design and fit-out projects in Business Bay by Casa kraft Interior Design & Renovation.",
              "mainEntity": {
                "@type": "ItemList",
                "itemListElement": [
                  {
