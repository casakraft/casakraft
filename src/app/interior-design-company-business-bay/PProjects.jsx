...
const AboutSection = () => {
      ...
      <div className="container mx-auto px-4 sm:px-8 lg:px-16">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="w-full  text-center ">
            ...
            <p className="text-justify text-white text-base sm:text font-play mb-6 leading-relaxed">
              As a leading <b className="text-[#caa193]"><a href="https://casakraftinteriors.ae/interior-design-companies-in-business-bay-dubai">interior design company in Business Bay</a></b> , we offer services for both commercial 
              ...
              ><a href="https://casakraftinteriors.ae/business-bay-apartment">apartment interior design Business Bay</a></b> services helps in 
              ...
              out contractors Business Bay and <b className="text-[#caa193]"><a href="https://casakraftinteriors.ae/fit-out-company-in-business-bay-dubai">fit-out company in Business Bay Dubai</a></b>, with 
        ...
        <div className="w-full lg:w-1/2 text-center lg:text-left">
          ...
          <p className="text-white text-sm sm:text-base font-play mb-4">
            ...
            ><a href="https://casakraftinteriors.ae/office-interior-design-trends-in-business-bay">office interior design Business Bay services</a></b> are based on delivering spaces that are functional,motivating and matching with the standard corporate environment in Dubai.
          </p>
         <h3 className="text-[#b98877] text-md font-conthrax mb-4 leading-tight">
                COMPREHENSIVE SOLUTIONS FOR HOMES AND BUSINESSES
             </h3>
          <p className="text-white text-sm sm:text-base mb-4 font-play">
            ...
            Other than  Business Bay, our <b className="text-[#caa193]"><a href="https://casakraftinteriors.ae/office-projects">office interior design projects</a></b> also cover the nearby areas of DIFC and Downtown Dubai, which means that all businesses in the main commercial areas of Dubai get to enjoy our expertise. 
          </p>
  ...
  <Link href="/contact-us">
    <button className="bg-[#b98877] hover:bg-[#b88f83] text-black font-conthrax px-6 py-3 rounded-md transition duration-300">
      ...
      <div className="text-center mt-10">
         <h2 className="text-[#b98877] text-2xl  font-conthrax mb-4 leading-tight">
            Why Choose Casa Kraft Interior design & renovationin Business Bay
  ...
  <div className="container mx-auto px-4 sm:px-8 lg:px-16">
    ...
    <div className="text-center mb-12">
      ...
      <p className="text-gray-300 max-w-3xl mx-auto font-play">
        ...
        including commercial offices, <b className="text-[#caa193]"><a href="https://casakraftinteriors.ae/business-bay-apartment-design">luxury Business Bay apartment designs</a></b>, restaurants, and turnkey solutions.
      </p>
    </div>
...
{/* ================= END Business Bay PROJECTS SECTION ================= */}
         ...
         <h2 className="text-[#b98877] text-2xl  font-conthrax mb-4 leading-tight">
           Local Expertise and Presence in Dubai
            ...
            <p className=" text-left mx-auto mt-0 md:mt-4 text-[12px] sm:text-base text-white py-2 md:py-6 font-play">
              Although Business Bay is our main area of providing services, our knowledge and expertise extend throughout Dubai and the UAE. Being one of the best interior design companies in Dubai, we have successfully completed various projects including <b className="text-[#caa193]"><a href="https://casakraftinteriors.ae/business-bay-travel-agency">travel agency Office</a></b>, Cafe Interiors, Business Bay restaurant and an apartment interior in different locations, always providing the best possible outcomes in luxury interior design Dubai, interior design in Dubai, and other upscale regions. <br /> <br />
            ...
            ><a href="https://casakraftinteriors.ae/interior-design-companies-in-business-bay-dubai">best interior design companies in Business Bay</a></b> is reinforced by a portfolio of satisfied clients across Dubai’s premium districts.
          ...
          <div className=" text-sm leading-relaxed font-play text-white">
            ...
            <p>
             Yes, we can. At Casa Kraft, we are experts in apartment interior design in Business Bay and luxury residential projects, designing homes that are both beautiful and functional.
            </p>
            ...
            <p>
             With our experience, quality work, and happy clients, Casa Kraft Interior Design & Renovation is one of the best interior design companies in Business Bay.
            </p>
