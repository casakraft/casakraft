...
const TestimonialCarousel = () => {
  const testimonials = [
    {
      quote:
        " Casa Kraft Interiors successfully made our retail space a contemporary, practical, and inspiring work environment. The entire project was executed efficiently. I recommend Casa Kraft Interiors for your retail interior designs & renovation services in Dubai.",
      author: "Sarah Williams, Business Bay",
    },
    {
      quote:
        "The retail redesign completed by Casa Kraft Interiors was truly exceptional from start to finish. Our workplace is now the perfect reflection of our brand personality while still offering us a functional space in which we can thrive.",
      author: "James Carter, Downtown, Dubai",
    },
    {
      quote:
        "Working with Casa Kraft Interiors was a great experience. They understood exactly what we wanted and transformed our retail into a modern and comfortable space. The team was professional, easy to work with, and delivered everything on time.",
...
const krSteps = [
  {
    ...
    desc: 'All stunning retail renovations begin with an important discussion. Throughout the discovery and consultation stage we learn about your company and the image you wish to portray. In addition, the project goals, timeline and budget are determined upfront thus ensuring clear direction moving forward.',
...
const faqs = [
  {
    question: 'Why is Casa Kraft regarded as one of the best retail interior design companies in Dubai?',
    answer:
      ' Casa Kraft is a combination of creativity and professionalism. Our team comprises highly skilled and professional designers, project managers, and fit-out professionals well versed with commercial environment of Dubai. This is why we are considered as one of the best retail interior design companies in Dubai.',
  },
  {
    question: 'Is it your practice to offer retail interior design and fit out services at the same time?',
    answer:
      ' Yes. Casa Kraft is a full-service studio where we offer comprehensive retail interior services including retail design and fit-out.',
  },
  {
    question: 'Do you have the capability to refurbish our current retail space?',
    answer:
      'We specialize in refurbs of existing retail spaces either partial or full scale. We study the space, determine how to improve on it and deliver a whole new look for your retail in the most minimally disruptive way possible.',
  },
  {
    question: 'How long does an Interior design project take in Dubai?',
    answer:
      'The amount of time taken to complete a project will depend on the scale and complexity of the job at hand. A basic retail fitout will generally take between 6 to 12 weeks. We will always give you a detailed plan right from the start.',
  },
  {
    question: 'Which styles of retail interior design is Casa Kraft known for?',
    answer:
      'Our retail interior design company offers a variety of styles including modern retail interior design, luxurious retail interior design, classic and contemporary. Every project we undertake is carefully crafted to suit the personality of your business.',
  },
...
<div className="max-w-7xl mx-auto px-6 py-10">
  ...
  <div className="grid md:grid-cols-2 gap-10 items-center">
    ...
    <div>
      ...
      Dubai is a place where international standards are set  and your retail interior design should match the trend. Being one of the <b className="text-[#4eb5a9]"><a href="https://casakraftinteriors.ae/">best interior designers in Dubai</a></b>, we at Casa kraft know very well what it takes to meet such high standards and expectations. It is our pleasure to be known among the most successful interior design firms in Dubai. We design and build commercial spaces such as corporate retails, executive suites, co-working environments and more throughout the UAE. Our team of expert architects, designers and artisans work together in order to create luxury retail interior designs that will help you take your work to new levels. Our company ranks as one of the top interior retail designs in Dubai not out of luck but because of dedication. </p>
    </div>
...
<div className="max-w-7xl mx-auto overflow-hidden">
  ...
  <div className="text-center mb-12">
    <h2 className="text-3xl text-white md:text-4xl font-semibold mb-4">
      Our Retail Interior Design Portfolio
    </h2>

    <p className="max-w-3xl mx-auto text-white/80">
       Explore a selection of thoughtfully designed retail spaces showcasing our expertise in creating functional, modern, and inspiring workplaces with premium finishes and meticulous attention to detail.
  ...
  <div className="relative overflow-hidden">
    <div className="flex animate-marquee gap-5 w-max">
     ...
     {[...retailGallery, ...retailGallery].map((project, index) => (
 <div
  key={index}
...
<div className="w-screen ml-[calc(50%-50vw)] bg-[#111111] mt-10 py-10">
  <div className="max-w-4xl mx-auto px-4 text-center">
    ...
    <p className="text-white/80 text-sm md:text-base mb-8">
      Retail Interior design & Renovation Company in Dubai
    </p>
...
<div className="mb-12">
    <h2 className="text-3xl md:text-4xl font-semibold text-white text-center mb-10">
        Key Factors That Affect Retail Design Cost </h2>

      <ul  class="list-disc"> <li > <b className="text-[#4eb5a9]">Retail size -</b> More materials and labour are required for bigger retails, although economies of scale might lower the per-square-foot cost. </li>
      ...
      <li ><b className="text-[#4eb5a9]">Smart retail technology - </b>While expensive at first, technology installations like automation systems, AV integration, intelligent lighting, and access control are more efficient in the long run. </li>
 ...
 <li ><b className="text-[#4eb5a9]">Project duration - </b>Projects that need fast turnarounds can cost extra. Average projects taking between four and 16 weeks are usually budget friendly.
      ...
      <p>Get a free and no-obligation quote. Every retail is different. Let Casa Kraft Interiors provide you with a personalized quote for your unique project.</p>
    </div>
  ...
  <TestimonialCarousel />
      ...
      <div className=" text-white/80 max-w-4xl mx-auto bg-black rounded-lg text-white/80  shadow p-6 sm:p-10">
        ...
        <p className="text-white/80 font-play text-sm sm:text-base text-white/80 mb-6 text-center">
          Find quick answers to common questions about our Retail Interior Design services in Dubai.
        </p>
      ...
      <div className="lg:max-w-[80%] text-white mx-auto bg-black p-6 sm:p-5 mb-5 rounded shadow text-center space-y-6">
             <h2 className="text-3xl md:text-4xl font-semibold text-white text-center mb-10">
         Transform Your Retail Today in Dubai - The Casa Kraft Way

        </h2>
        <div className="space-y-4 text-white/80 text-sm sm:text-base font-play text-left">
        <p>
      Retail interior design is about more than just being aesthetically pleasing; it increases productivity, portrays your brand, and creates an environment that makes you proud to be in it. As a top-rated retail interior design company in Dubai, we do not just create retail spaces; we create the future of your business. Whether you require modern retail interior designs, luxury <b className="text-[#4eb5a9]"><a href="https://casakraftinteriors.ae/">retail interior design services</a></b>, or an entire retail interior fit out in Dubai, we are the team that you have been searching for.
