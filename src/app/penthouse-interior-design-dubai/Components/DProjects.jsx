...
const TestimonialCarousel = () => {
  const testimonials = [
    {
      quote:
        " Casa Kraft Interiors successfully made our penthouse space a contemporary, practical, and inspiring work environment. The entire project was executed efficiently. I recommend Casa Kraft Interiors for your penthouse interior designs & renovation services in Dubai.",
      author: "Sarah Williams, Business Bay",
    },
    {
      quote:
        "The penthouse redesign completed by Casa Kraft Interiors was truly exceptional from start to finish. Our workplace is now the perfect reflection of our brand personality while still offering us a functional space in which we can thrive.",
      author: "James Carter, Downtown, Dubai",
    },
    {
      quote:
        "Working with Casa Kraft Interiors was a great experience. They understood exactly what we wanted and transformed our penthouse into a modern and comfortable space. The team was professional, easy to work with, and delivered everything on time.",
...
const penthouseGallery = [
  {
    image: "/images/penthouse-racks.png",
  },
  {
    image: "/images/CEO-penthouse-interior-renovations.png",
  },
  {
    image: "/images/penthouse-interior-in-dubai.jpg",
  },
  {
    image: "/images/Interior design company twin tower dubai.png",
  },
  {
    image: "/images/penthouse-interiors-and-renovations.png",
   },
  {
    image: "/images/penthouse-sitting-area-for-clients.png",
  },
...
const krSteps = [
  {
    ...
    desc: 'All stunning penthouse renovations begin with an important discussion. Throughout the discovery and consultation stage we learn about your company and the image you wish to portray. In addition, the project goals, timeline and budget are determined upfront thus ensuring clear direction moving forward.',
...
const faqs = [
  {
    question: 'Why is Casa Kraft regarded as one of the best penthouse interior design companies in Dubai?',
    answer:
      ' Casa Kraft is a combination of creativity and professionalism. Our team comprises highly skilled and professional designers, project managers, and fit-out professionals well versed with commercial environment of Dubai. This is why we are considered as one of the best penthouse interior design companies in Dubai.',
  },
  {
    question: 'Is it your practice to offer penthouse interior design and fit out services at the same time?',
    answer:
      ' Yes. Casa Kraft is a full-service studio where we offer comprehensive penthouse interior services including penthouse design and fit-out.',
  },
  {
    question: 'Do you have the capability to refurbish our current penthouse space?',
    answer:
      'We specialize in refurbs of existing penthouse spaces either partial or full scale. We study the space, determine how to improve on it and deliver a whole new look for your penthouse in the most minimally disruptive way possible.',
  },
  {
    question: 'How long does an Interior design project take in Dubai?',
    answer:
      'The amount of time taken to complete a project will depend on the scale and complexity of the job at hand. A basic penthouse fitout will generally take between 6 to 12 weeks. We will always give you a detailed plan right from the start.',
  },
  {
    question: 'Which styles of penthouse interior design is Casa Kraft known for?',
    answer:
      'Our penthouse interior design company offers a variety of styles including modern penthouse interior design, luxurious penthouse interior design, classic and contemporary. Every project we undertake is carefully crafted to suit the personality of your business.',
  },
...
<div className="max-w-7xl mx-auto px-6 py-10">
  ...
  <div className="grid md:grid-cols-2 gap-10 items-center">
    ...
    <div>
      ...
      Dubai is a place where international standards are set  and your penthouse interior design should match the trend. Being one of the <b className="text-[#4eb5a9]"><a href="https://casakraftinteriors.ae/">best interior designers in Dubai</a></b>, we at Casa kraft know very well what it takes to meet such high standards and expectations. It is our pleasure to be known among the most successful interior design firms in Dubai. We design and build commercial spaces such as corporate penthouses, executive suites, co-working environments and more throughout the UAE. Our team of expert architects, designers and artisans work together in order to create luxury penthouse interior designs that will help you take your work to new levels. Our company ranks as one of the top interior penthouse designs in Dubai not out of luck but because of dedication. </p>
    </div>

    {/* Right Side - Image */}
    <div className="relative overflow-hidden rounded-xl">
      <Image
        src="/images/CEO-penthouse-interior-renovations.png"
...
<div className="max-w-7xl mx-auto overflow-hidden">
  ...
  <div className="text-center mb-12">
    ...
    <p className="max-w-3xl mx-auto text-white/80">
       Explore a selection of thoughtfully designed penthouse spaces showcasing our expertise in creating functional, modern, and inspiring workplaces with premium finishes and meticulous attention to detail.
  ...
  <div className="max-w-7xl mx-auto px-4">
    ...
    <h2 className="text-3xl md:text-4xl font-semibold text-white text-center mb-10">
      ...
      <p className="text-zinc-400 mx-auto">
       With Casa Kraft Interior Design & Renovation, we offer the <b className="text-[#4eb5a9]"><a href="https://casakraftinteriors.ae/penthouse-renovation-dubai">best penthouse interior design and renovation services</a></b> in all of Dubai's best business districts and commercial areas. Whether you are looking for a modern corporate penthouse, an executive penthouse, or full renovation of your current penthouse space, we can help! We proudly work for businesses located in Business Bay, DIFC, Downtown Dubai, Dubai Marina, JLT, Dubai Internet City, Dubai Media City, Dubai Silicon Oasis, and penthouses on Sheikh Zayed Road. With years of experience designing penthouse spaces in all of these top commercial spots, we are experts at delivering the right design for your business.
      </p>
    </div>

<div className="mb-12">
    <h2 className="text-3xl md:text-4xl font-semibold text-white text-center mb-10">
        Key Factors That Affect penthouse Design Cost </h2>

      <ul  class="list-disc"> <li > <b className="text-[#4eb5a9]">penthouse size -</b> More materials and labour are required for bigger penthouses, although economies of scale might lower the per-square-foot cost. </li>
      ...
      <li ><b className="text-[#4eb5a9]">Smart penthouse technology - </b>While expensive at first, technology installations like automation systems, AV integration, intelligent lighting, and access control are more efficient in the long run. </li>
 ...
 <li ><b className="text-[#4eb5a9]">Project duration - </b>Projects that need fast turnarounds can cost extra. Average projects taking between four and 16 weeks are usually budget friendly.
      ...
      <p>Get a free and no-obligation quote. Every penthouse is different. Let Casa Kraft Interiors provide you with a personalized quote for your unique project.</p>
    </div>
...
<div className="max-w-4xl mx-auto my-12">
  <TestimonialCarousel />
      ...
      <div className="lg:max-w-[80%] text-white mx-auto bg-black p-6 sm:p-5 mb-5 rounded shadow text-center space-y-6">
             <h2 className="text-3xl md:text-4xl font-semibold text-white text-center mb-10">
         Transform Your penthouse Today in Dubai - The Casa Kraft Way

        </h2>
        <div className="space-y-4 text-white/80 text-sm sm:text-base font-play text-left">
        <p>
      penthouse interior design is about more than just being aesthetically pleasing; it increases productivity, portrays your brand, and creates an environment that makes you proud to be in it. As a top-rated penthouse interior design company in Dubai, we do not just create penthouse spaces; we create the future of your business. Whether you require modern penthouse interior designs, luxury <b className="text-[#4eb5a9]"><a href="https://casakraftinteriors.ae/">penthouse interior design services</a></b>, or an entire penthouse interior fit out in Dubai, we are the team that you have been searching for.
