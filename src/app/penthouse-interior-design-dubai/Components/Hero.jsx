...
const Hero = () => {
  ...
  return (
    <div className="relative w-full h-auto md:h-[500px] lg:h-[550px] overflow-hidden">
      <Image
        src="/images/mg-1.png"
        alt="PEnthouse interior design and Renovation Dubai"
        width={1920}
        height={1080}
        priority
      ...
      <div className="relative z-20 mt-10 flex flex-col lg:flex-row items-center justify-between w-full h-full px-4 md:px-10 lg:px-20 py-10 gap-8">
        <div className="text-white/80 max-w-xl">
          ...
          Looking for professional penthouse interior designers in Dubai? Casa Kraft Interiors creates penthouse spaces with complete design and fit-out solutions. Call Now!</p>
