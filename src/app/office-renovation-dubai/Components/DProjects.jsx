...
const TestimonialCarousel = () => {
  const testimonials = [
    {
      quote:
        "Working with Casa Kraft has been an absolute pleasure for our business. We needed an innovative office space that would match our brand identity and boost productivity among our employees. They took care of all phases of our renovation needs from design to execution. We recommend Casa Kraft without hesitation.",
      author: "Mohammed Zaviyar, Business Bay, Dubai",
    },
    {
      quote:
        "Deciding to renovate our office by using the services of Casa Kraft has turned out to be one of the best decisions we have ever taken. The people at Casa Kraft converted our old-looking office into a modern, elegant one that matches our way of life. It’s hard to express how pleased we are with their work ",
      author: " MR. Ahmer, DIFC",
    },
  ];
...
const krSteps = [
  {
    ...
    desc: 'All renovation projects start off by getting acquainted with the needs of the customer. At the stage of the first meeting, our company analyzes your office, studies your needs, and highlights areas that require improvements.',
  },
  {
    id: '02',
...
const faqs = [
  {
    ...
    answer:
      ' Casa Kraft is a combination of creativity and professionalism. Our team comprises highly skilled and professional designers, project managers, and fit-out professionals well versed with Dubai commercial environment. We are famous for our ability to give luxury and functionality in our designs and we deliver them promptly. This is why we are considered as one of the best office interior design companies in Dubai.',
  },
  {
  ...
  {
    question: 'Is it possible to refurbish offices without stopping business operations?',
    answer:
      'Yes. Our crew ensures proper planning of office renovation and, if necessary, will apply phased construction principles.',
  },
  {
    question: 'Are you able to integrate smart office technologies?',
    answer:
      'Yes. We deliver smart office services such as automation of lighting, climate, access and security systems, as well as meeting room management technologies.',
  },
];
const fadeUp = {
  hidden: {
...
>     <motion.h2
  ...
  className="text-2xl sm:text-3xl md:text-4xl font-semibold text-white text-center mb-6 sm:mb-10"
>
      Why Casa Kraft Is Dubai's Leading Office Renovation Company
       </motion.h2>
        <motion.div
  initial="hidden"
  whileInView="visible"
...
>
          <p>
      The success of your renovation is dependent on the contractor you select. Let us show you how businesses in Dubai have trusted our company, Casa Kraft Interior Design and Renovation, for office renovation Dubai services. Our team of professionals with a wealth of experience offers excellent office renovation services Dubai services for different industries such as finance, technology, healthcare, and retail. The process will begin with your expectations, and our team of designers will come up with <b className="text-[#4eb5a9]"
     ><a href="https://casakraftinteriors.ae/office-interior-design-dubai">bespoke office interior designs</a></b> based on your expectations. Our team ensures that your new interior design meets the functional requirements and aesthetic needs of our employees. This means that we incorporate smart solutions and technology such as advanced sound systems, AV technology, smart lighting systems, and networking technologies in the renovation process. Our team of designers focuses on creating interiors that reflect elegance and functionality of the space. We offer diligent design services and cost effective solutions for every project.
      ...
      <div className="w-full overflow-hidden">
        <div className="text-center mb-8 sm:mb-12 px-6">
          <h2 className="text-2xl sm:text-3xl md:text-4xl text-white font-semibold mb-4">
            Our Office Renovation Portfolio
          </h2>
          <p className="max-w-3xl mx-auto text-white/80 text-sm sm:text-base">
            Explore a selection of beautifully designed Offices showcasing our craftsmanship,
...
>
           ...
           Our Office Renovation Process In Dubai
...
>
          ...
          Office Renovation Across Dubai
  ...
  className="text-2xl sm:text-3xl md:text-4xl font-semibold text-white text-center mb-6 sm:mb-10"
>
          Office Renovation in Dubai – FAQs
       </motion.h2>
        <p className="text-white/80  text-sm sm:text-base mb-6 text-center">
          Find quick answers to common questions about our Office Renovation services in Dubai.
        </p>
      ...
      {selectedImage && (
       ...
       <h2 className="text-3xl md:text-4xl font-semibold text-white text-center mb-10">Transform Your Workspace with Casa Kraft

</h2>
<p className="text-zinc-400 max-w-5xl text-center mb-10 mx-auto text-sm sm:text-base">
 An office refurbished by professionals makes an immediate positive impact on everyone, boosts employee motivation, and helps in achieving organizational success. At Casa Kraft Interior Design & Renovation, we blend creativity, expertise and project management skills to provide exceptional <b className="text-[#4eb5a9]"
 ><a href="https://casakraftinteriors.ae/renovation-dubai">renovation services throughout Dubai</a></b> . Whatever you need a contemporary look for your office, luxury commercial renovations, fit-out services or a workplace redesign, we are here to help you transform your space.
