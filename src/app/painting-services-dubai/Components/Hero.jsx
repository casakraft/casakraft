...
const Hero = () => {
  ...
  return (
    <div className="relative w-full h-auto md:h-[500px] lg:h-[550px] overflow-hidden">
      <Image
        src="/images/pn7.png"
        alt="Villa painting services in dubai"
        width={1920}
        height={1080}
        priority
      ...
      <div className="relative z-20 mt-10 flex flex-col lg:flex-row items-center justify-between w-full h-full px-4 md:px-10 lg:px-20 py-10 gap-8">
        <div className="text-white/80 max-w-xl">
         ...
         Looking for painting services in Dubai? Casa Kraft provides residential and commercial painting for villas, apartments, offices etc. Contact Us Today! 
 </p>
