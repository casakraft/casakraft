  ...
  return (
    <section className="relative w-full h-screen overflow-hidden">
      ...
      <Image
        ...
        alt="Luxury Interior Design in bluewaters Dubai"
        fill
        priority
      ...
      <div className="relative z-20 flex items-center h-full">
        <div className="max-w-6xl px-6 md:px-16 text-white">
          ...
          <h1 className="text-3xl sm:text-5xl md:text-4xl font-conthrax leading-tight">
           Interior Design Company in <br />bluewaters , Dubai
          </h1>

          {/* Subheading */}
          <p className="font-play mt-6  max-w-2xl text-gray-200">
          Casa Kraft Interior design & renovation is a leading Interior Design Company in bluewaters , Dubai, and 
            provides the best interior design services for residential, commercial, and retail projects. 
           Bluewaters  is one of the most prominent areas of Dubai as it is famous for its luxurious 
          ...
          <div className="mt-8">
            <button className="bg-[#b98877] hover:bg-[#b88f83] text-black font-conthrax px-6 py-3 rounded-md transition duration-300">
             <a href="https://casakraftinteriors.ae/gallery">Our Bluewaters Dubai Projects</a> 
            </button>
          </div>
