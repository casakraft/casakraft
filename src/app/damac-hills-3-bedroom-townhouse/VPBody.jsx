...
const galleryImages = [
  ...
  { src: "/images/dht-2.png", alt: "Large 1" },
  { src: "/images/dht-3.png", alt: "Small 1" },
  { src: "/images/dht-4.png", alt: "Small 2" },
  { src: "/images/dht-5.png", alt: "Small 3" },

  // --- 2nd block (1 large + 3 small) ---
  { src: "/images/dht-6.png", alt: "Large 2" },
  { src: "/images/dht-7.png", alt: "Small 4" },
  { src: "/images/dht-8.png", alt: "Small 5" },
  { src: "/images/dht-4.png", alt: "Small 6" },
];
  ...
  return (
    <section className="bg-[#332e2a] text-white">
      <div className="mx-auto w-full max-w-[1200px] px-4 sm:px-6 lg:px-8 py-10 sm:py-14 lg:py-16">
        ...
        <SectionHeader
          as="h1"
          title="Damac Hills 3 Bedroom Apartment"
          text=""
        />
