...
export const metadata = {
  title: "Best Interior Design Company in palm jumeirah, Dubai - Casa Kraft Interiors",
  description:
            ...
            __html: JSON.stringify({
              ...
              "mainEntity": [
                ...
                },
                {
                  ...
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Casa Kraft interior design & Renovation is recognized for delivering high-quality residential and commercial interior design and fit-out projects in palm jumeirah."
                  }
                }
              ]
            })
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "url": "https://casakraftinteriors.ae/interior-design-palm-jumeirah",
              "description": "A curated collection of luxury interior design and fit-out projects in palm jumeirah by Casa Kraft interior design & Renovation.",
              "mainEntity": {
                "@type": "ItemList",
                "itemListElement": [
                  {
