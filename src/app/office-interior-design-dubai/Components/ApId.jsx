 ...
 
{
  ...
  desc: "Your corporate office speaks before you do. The concept of our corporate office interior design services relies on the idea of knowing your story, your processes, and how you would like your clients and employees to feel. From executive conference rooms or flexible workstations, we design environments that symbolize power, innovation and professionalism. We take care of everything  from space planning and materials selection to acoustics and finishing."
},

  {
    title: "→ Commercial Office Interior Design in Dubai",
    desc: "In Dubai, Casa Kraft Interiors is known for providing highly creative commercial office interior designing services in Dubai. Our designers have created many modern offices that improve performance and help build a strong image of our client's business among its customers. If you need to develop a modern corporate office, luxurious commercial office interior design, or any other kind of office interior space, our expert interior designing team will do the job in no time."
  },
  {
    title: "→ Modern Office Interior Design",
    desc: "Straight lines. Plenty of room. Good layouts. In our approach to modern office interior design, we follow modern design concepts of utilizing natural light, encouraging teamwork, and embedding technology within the setting. Our office interior designs are infused with some of the latest concepts in office interior designs to make your work environment future-friendly."
  },
 {
  title: "→ Office Interior Fit-Out Services",
  desc: "Casa kraft provides full-service office interior fit-out services covering all aspects of the process, right up until completion. Being one of the premier interior fit-out services in Dubai, we take care of all the construction, sourcing, installation, and finishing of your project while adhering to schedules and budget considerations."
},
  {
  title: "→ Industrial Office Interior Design",
  desc:"The industrial office interior is one office interior design type that will make your work environment feel authentic, full of energy, and very unique. Inspired by old factories, warehouses, and creative studio work environments, industrial interior design takes the elements of your building structure and turns them into design highlights that give you an incredible interior that stands out on its own. At Casa Kraft Interior Design & Renovation, we know how to create amazing industrial office interiors in Dubai."
},

   {
    title: "→  Executive Office Interior Design in Dubai ",
    desc: "Casa Kraft Interiors prides itself on designing exquisite executive office interiors that convey the sophistication, professionalism and success of those working in such spaces. Our executive office interior design services involve everything from space planning to customized furniture design, high end material selection, lighting design, acoustic design, smart office design and custom joinery design. "
  },

   {
    title: "→  Office Renovation & Remodeling",
    desc: "Is your office out of date? Do you need to change your number of employees? Rebranding? With our office interior design services, we help make your existing space modern without having to do a complete relocation. We examine your present arrangement and redesign your working space effectively."
  },

  {
    title: "→  Smart Office interior design",
    desc: "Casa Kraft Interiors offers the most sophisticated solutions for designing smart office interiors that incorporate technology in an elegant way. We can offer you our expertise in creating the perfect solution for designing your smart office interior that comprises automation systems such as light and air conditioning, smart meeting rooms, access controls and other workplace technologies that boost productivity and efficiency. Our skilled professionals will be glad to help you create a unique and sophisticated workplace."
  },
