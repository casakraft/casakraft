...
const galleryImages = [
  { src: '/images/citywalk-1.png', link: '/city-walk-3-bedroom-apartment', title: 'CITY WALK APARTMENT' },
  { src: '/images/marina-2.png', link: '/marina-gate-penthouse', title: 'MARINA GATE PENTHOUSE' },
  { src: '/images/nba-7.png', link: '/nikki-beach-2-bedroom-apartment', title: 'NIKKI BEACH APARTMENT' },
  { src: '/images/gp-11.png', link: '/palm-jumeirah-apartment', title: 'PALM JUMEIRAH APARTMENT' },
  { src: '/images/dca-3.png', link: '/dubai-creek-2-bedroom-apartment', title: 'DUBAI CREEK HARBOUR APARTMENT' },
  { src: '/images/atr-1.png', link: '/royal-atlantis-apartment', title: 'ROYAL ATLANTIS APARTMENT' },
];
...
const DProjects = () => {
  return (
    <section className="px-6 py-10 bg-[#f5f5f5]">
      ...
      {/* Top Content Block */}
      <div className="lg:max-w-[60%] mx-auto bg-[#ffffff] p-6 sm:p-10 rounded shadow text-center space-y-6 mb-12">
        <h2 className="text-sm sm:text-xl md:text-xl tracking-widest font-bold">
 ...
 <div className="space-y-4 text-sm sm:text-base font-play text-left">
  <p>
    ...
    in limited space, comfort in rental settings, and optimizing every detail for modern city life.
     At Casa Kraft Interiors, we specialize in designing small and mid-sized apartments 
     that feel spacious, stylish, and truly personal — even if it’s a studio or 2-bedroom apartment 
     in Atlantis The Royal or Downtown.
  ...
  <p><strong>Our mission:</strong> turn every apartment into a welcoming, livable space that feels
      ...
      <div className="lg:max-w-[60%] mx-auto flex flex-col lg:flex-row items-start gap-6 mb-12">
        <div className="w-full lg:w-2/3 space-y-4">
          <h3 className="text-sm sm:text-xl md:text-xl tracking-widest font-conthrax">
          ...
          <p className="text-sm sm:text-base font-play">
           ...
           seeking modern minimalism with character. At Casa Kraft, we integrate 
  ...
  <div className="flex flex-col sm:flex-row justify-center gap-4 mt-4 px-4">
    ...
    <a
      href="mailto:info@casakraftinters.ae"
    ...
    >
      ✉️ Request availability by E-mail
        ...
        <h2 className="text-center text-3xl font-bold py-12">
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center mb-16">
          <div className="space-y-6 font-play">
            ...
            <p>
            At Casa Kraft Interiors, we believe luxury should be personal, practical, and seamless. That’s why we offer
            ...
            <h3 className='font-play'>Material & Furniture Curation</h3>
             <p className='font-play'> Style discovery, space analysis, and mood boards
               tailored to your vision.</p>
            </li>

             <li>
            <h3 className='font-'>Project Documentation</h3>
             <p className='font-play'> We collaborate with Dubai’s top suppliers to handpick furnishings, fabrics, and décor that align with your taste and lifestyle.</p>
            </li>

             <li>
            <h3 className='font-play'>On-Site Supervision & Execution</h3>
             <p className='font-play'> Every layout, lighting plan, and color specification is documented for accuracy and transparency.</p>
            </li>

             <li>
            <h3 className='font-play'>Personalized Design Development</h3>
             <p className='font-play'> Our project managers oversee every phase of implementation — from painting to furnishing — ensuring flawless results.</p>
            </li>
            </ul>
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
          ...
          <div className="space-y-6 font-play">
            ...
            <p>
              Your home should be a perfect combination of your personal style and thoughtful design. At <a href="https://casakraftinteriors.ae.ae/">Casa Kraft Interiors</a>, our professional designers help you create apartment interiors that are elegant, efficient, and personalized — no matter your budget.
            </p>
            <p>
           ...
           {/* last paragraph */}
           <div className="lg:max-w-[60%] mx-auto bg-[#ffffff] p-6 sm:p-10 rounded shadow space-y-6 mb-12 mt-6">
        {/* Heading */}
        <div className="text-center">
          ...
          <p className="font-play text-sm sm:text-base text-start py-2">
          Choosing the right furniture for apartment interior design in Dubai is about more than just style — it’s about fitting function into form. At Casa Kraft, we understand the challenges of urban living: tight corners, open layouts, awkward niches, and the need for maximum storage in minimal space.
          </p>
           <p className="font-play text-sm sm:text-base text-start py-2">
        ...
        <div>
          ...
          <h3 className="font-play text-sm sm:text-base">
          We design with purpose :</h3>
       <ul className="list-disc list-inside font-play text-sm sm:text-base">
  ...
  <li>Accent pieces that add personality without crowding</li>
       ...
       <p className="font-play text-sm sm:text-base"> 💡 TIP: Dark walls? <br></br>We use mirrored panels and uplighting to create visual depth — a proven strategy in our Dubai Marina and Downtown projects.
        </p>
        </div>
