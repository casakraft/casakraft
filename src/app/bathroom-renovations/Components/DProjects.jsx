...
const krSteps = [
  {
    ...
    desc: 'Evaluate the needs and conduct site assessment regarding Dubai bathroom renovation.',
    img: '/images/our-mission.png',
  },
  {
    id: '02',
    title: 'Design Concept & 3D Visualization',
    desc: 'Develop complete layouts for your bathroom design and construction.',
    img: '/images/material high quality.png',
  },
  {
    id: '03',
    title: 'Material Selection and Budget Planning',
    desc: 'Choose the highest quality tiles, fittings and premium materials for renovation.',
    img: '/images/best-customized-services.png',
  },
  {
    id: '04',
    title: 'Approval & Permits',
    desc: 'Manage approvals, as in bathroom renovation in Dubai villa and apartment approvals.',
    img: '/images/our-mission.png',
  },
  {
    id: '05',
    title: 'Demolition and Waterproofing',
    desc: 'Provide long lasting, leak tight finishes for all projects undertaken by bathroom renovation specialists.',
    img: '/images/material high quality.png',
  },
  {
    id: '06',
    title: 'Construction & Installation',
    desc: 'Undertake the installation of fixtures, vanities, cabinets, as well as bathroom fit out contractors in Dubai solutions.',
    img: '/images/best-customized-services.png',
  },

  {
    ...
    desc: 'Final checks will be done to ensure your high quality bathroom renovation and remodeling meets our standards.',
    img: '/images/best-customized-services.png',
  },
];
...
const faqs = [
  {
    question: 'How much does it cost to renovate a bathroom in Dubai?',
    answer:
      'The bathroom renovation cost in Dubai depends on size, materials, fixtures, and type of service you choose, a standard or luxury bathroom renovation Dubai project.',
  },
  {
    question: 'What are the most important factors to consider when planning a bathroom renovation?',
    answer:
      'The most important factors to consider are budget, layout, plumbing condition, bathroom waterproofing Dubai, ventilation, material quality, and required approvals.',
  },
  {
    question: 'How do you choose the right flooring for a bathroom renovation?',
    answer:
      'Choose water-resistant, anti-slip bathroom flooring such as porcelain tiles, ceramic tiles, or sealed natural stone for durability and safety',
  },
  {
    question: 'What are the stages of bathroom renovation?',
    answer:
      'The stages of a bathroom renovation in Dubai include consultation, design, material selection, approvals, demolition, waterproofing, installation, and handover.',
  },

  {
    question: 'How long does a bathroom renovation take?',
    answer:
      'A typical bathroom renovation Dubai project takes around 2 to 4 weeks, depending on the scope, approvals, and material availability.',
  },
...
<div className="max-w-7xl mx-auto overflow-hidden">
  ...
  <div className="text-center mb-12">
    ...
    <p className="max-w-3xl mx-auto text-white/80">
      Explore a selection of beautifully designed Bathrooms showcasing our
  ...
  <div className="relative overflow-hidden">
    <div className="flex animate-marquee gap-5 w-max">
      ...
      {[...bathroomGallery, ...bathroomGallery].map((image, index) => (
        <div
          key={index}
...
<div className="bg-black text-white/80py-14">
  <div className="max-w-6xl mx-auto px-4">
    ...
    Our Bathroom Renovation Process in Dubai
    </h2>
  ...
  <div className="max-w-7xl mx-auto px-4">
    ...
    <h2 className="text-3xl md:text-4xl font-semibold text-white text-center mb-10">
      ...
      <p className="text-zinc-400 max-w-2xl mx-auto">
        Delivering luxury Bathroom interior design and renovation projects
...
<div className="max-w-4xl mx-auto my-12">
  <TestimonialCarousel />
      ...
      <div className=" text-white/80 max-w-4xl mx-auto bg-black rounded-lg text-white/80  shadow p-6 sm:p-10">
        <h2 className="text-3xl md:text-4xl font-semibold text-white text-center mb-10">
         Bathroom Renovation in Dubai – FAQs
        </h2>
        <p className="text-white/80 font-play text-sm sm:text-base text-white/80 mb-6 text-center">
          Find quick answers to common questions about our Bathroom Renovation services in Dubai.
        </p>
